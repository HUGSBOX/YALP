...
While this manual isn't here for the purpose of explaining the source code,
...
This is the basic principle of the GPL licence.
...
Please note that many methuselah will not stabalize as expected due to the
